...
class PermissionsHelper {
     ...
     */
    fun withActivity(activity: Activity?): PermissionsHelper {
     ...
     */
    fun withFragment(fragment: Fragment?): PermissionsHelper {
     ...
     */
    fun check(permission: String): PermissionsHelper {
     ...
     * @return current object
     */
    fun check(vararg permissions: String): PermissionsHelper {
     ...
     * @return current object
     */
    fun onSuccess(listener: Runnable?): PermissionsHelper {
     ...
     * @return current object
     */
    fun onDenied(listener: Runnable?): PermissionsHelper {
    ...
    fun onFailure(listener: Runnable?): PermissionsHelper {
        deniedListener = listener
        return this
    }
     ...
     * @return current object
     */
    fun onNeverAskAgain(listener: Runnable?): PermissionsHelper {
     ...
     * @return current object
     */
    fun setDialogPositiveButtonColor(@ColorRes colorRes: Int): PermissionsHelper {
